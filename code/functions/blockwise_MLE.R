# These functions are for fitting local MLEs at each location. They include 
# helper functions for subsetting locations and data, likelihood functions
# for Matern-1/2 and Matern-3/2 functions, and a function that finds the MLEs
# for each windowed location. See paper for details on the model.
...
m0.5_lik <- function(par, data_mat_sub, dist_pairs_mat) {
  ...
  # dropping constant terms for maximization. This is equation 5.13 of Diggle
  # and Ribiero.
  loglik <- -0.5 * (n * determinant(cov_mat)$modulus +
