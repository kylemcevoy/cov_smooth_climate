"""
Pre-processing of ERA5 data to form a time series of July Central US 2m
air temperature from 1959 to 2008. This time series is used in the paper
application. The time series is de-trended in the application script 
...
# cosine weighting latitude gives an area-weighted average
