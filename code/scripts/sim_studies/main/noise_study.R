...
sim_sd1_path <- paste0(save_dir, "sim_n50_sd1_phi4_taper7.csv")
...
sim_sd2_path <- paste0(save_dir, "sim_n50_sd2_phi4_taper7.csv")
...
sim_sd3_path <- paste0(save_dir, "sim_n50_sd3_phi4_taper7.csv")
